...
public class Materia implements Informacion{
    ...
    public String listarContenidos(){
        String resultado = "";
        for (Estudiante estudiante: this.coleccionEstudiantes){
            resultado = resultado + estudiante.getNombre() + "\n";
        }

        return resultado;
    }

    //Para saber la cantidad de estudiantes que hay en coleccionEstudiantes usamos el metodo size que nos proporciona el ArrayList
